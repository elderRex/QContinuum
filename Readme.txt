...
There is a class missing for sending email for password reset, which we can't include on a public repository because it relies on a SendGrid key that must remain private.
